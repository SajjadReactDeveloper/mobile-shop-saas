    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="border-b border-gray-100 sticky top-0 bg-white/90 backdrop-blur z-40">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/auth/register" className="text-sm bg-blue-600 text-white font-medium px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
              Start Free Trial
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <h1 className="text-5xl font-extrabold text-gray-900 leading-tight max-w-3xl mx-auto">
          Run your mobile shop <span className="text-blue-600">without the headache</span>
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/auth/register"
            className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors text-base shadow-lg shadow-blue-200">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center text-white">
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div>
              ...
              <div className="text-blue-200 text-sm mt-1">Modules built-in</div>
            </div>
            <div>
              <div className="text-4xl font-extrabold">PKR 0</div>
              <div className="text-blue-200 text-sm mt-1">To get started</div>
            </div>
            <div>
              <div className="text-4xl font-extrabold">14</div>
              <div className="text-blue-200 text-sm mt-1">Day free trial</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20" id="pricing">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {tiers.map(tier => (
            <div key={tier.name}
              className={`rounded-2xl border-2 p-8 flex flex-col gap-5 ${tier.highlight ? 'border-blue-500 shadow-xl shadow-blue-100 relative' : 'border-gray-200'}`}>
              {tier.highlight && (
              ...
              <Link href={tier.href}
                className={`text-center py-3 rounded-xl font-semibold text-sm transition-colors ${tier.highlight ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}>
                {tier.cta}
              </Link>
            </div>
          ))}
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <Link href="/auth/register"
          className="mt-8 inline-block px-10 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200 text-base">
