    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex gap-3 mt-6">
            {[
              ...
              <a key={label} href={href} aria-label={label}
                className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-violet-600 flex items-center justify-center transition-colors group">
        ...
        <div>
          ...
          {/* Clean CTA — no nested card */}
          <Link href="/auth/register"
            className="inline-flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold px-5 py-3 rounded-xl transition-colors shadow-lg shadow-violet-900/30">
