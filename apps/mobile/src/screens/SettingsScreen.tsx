...
const ROLE_COLOR: Record<UserRole, string> = { OWNER: '#2563eb', CASHIER: '#2563eb', TECHNICIAN: '#d97706' }
const ROLE_BG: Record<UserRole, string> = { OWNER: '#eff6ff', CASHIER: '#eff6ff', TECHNICIAN: '#fffbeb' }

const TIER_BADGE: Record<SubscriptionTier, { bg: string; text: string }> = {
  FREE:     { bg: '#f3f4f6', text: '#374151' },
  PRO:      { bg: '#dbeafe', text: '#1d4ed8' },
  BUSINESS: { bg: '#f3e8ff', text: '#1d4ed8' },
}
...
const s = StyleSheet.create({
  ...
  tabBar:           { flexDirection: 'row', backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#dbeafe', paddingHorizontal: 16, paddingTop: 8 },
  ...
  saveBtn:          { backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 14, alignItems: 'center', marginBottom: 12, shadowColor: '#2563eb', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6, elevation: 4 },
  ...
  staffRowBorder:   { borderTopWidth: 1, borderTopColor: '#eff6ff' },
  staffAvatar:      { width: 42, height: 42, borderRadius: 21, backgroundColor: '#eff6ff', justifyContent: 'center', alignItems: 'center' },
  staffAvatarText:  { fontSize: 17, fontWeight: '800', color: '#2563eb' },
  staffName:        { fontSize: 14, fontWeight: '700', color: '#111827' },
  staffContact:     { fontSize: 12, color: '#9ca3af', marginTop: 2 },
  roleBadge:        { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  roleText:         { fontSize: 11, fontWeight: '700' },
  infoBox:          { backgroundColor: '#eff6ff', borderRadius: 12, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#dbeafe' },
