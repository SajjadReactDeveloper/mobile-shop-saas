...
const s = StyleSheet.create({
  ...
  advBtn:         { marginTop: 10, backgroundColor: '#f5f3ff', borderRadius: 8, paddingVertical: 8, alignItems: 'center' },
  ...
  selectedCustomer: { backgroundColor: '#f5f3ff', borderRadius: 8, padding: 10, flexDirection: 'row', alignItems: 'center' },
  ...
  saveBtn:        { backgroundColor: '#7c3aed', borderRadius: 12, paddingVertical: 14, alignItems: 'center', marginTop: 24, marginBottom: 40 },
