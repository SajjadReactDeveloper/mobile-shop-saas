...
const s = StyleSheet.create({
  ...
  searchRow:        { flexDirection: 'row', gap: 8, padding: 12, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#dbeafe' },
  ...
  sectionTitle:     { fontSize: 12, fontWeight: '700', color: '#374151', padding: 14, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#eff6ff' },
