...
const s = StyleSheet.create({
  ...
  searchRow:        { flexDirection: 'row', gap: 8, padding: 12, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#ede9fe' },
  ...
  sectionTitle:     { fontSize: 12, fontWeight: '700', color: '#374151', padding: 14, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#f5f3ff' },
