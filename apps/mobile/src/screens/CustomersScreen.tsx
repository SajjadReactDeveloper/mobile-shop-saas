...
const s = StyleSheet.create({
  ...
  udhaarAmt:        { fontSize: 14, fontWeight: '700', color: '#dc2626' },
  udhaarLabel:      { fontSize: 11, color: '#f87171', marginTop: 1 },
  ...
  // Detail view
  balanceCard:      { margin: 12, borderRadius: 16, padding: 16, borderWidth: 1 },
  ...
  reminderBtn:      { marginHorizontal: 12, marginBottom: 8, backgroundColor: '#f0fdf4', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: '#bbf7d0' },
  reminderBtnText:  { color: '#15803d', fontWeight: '700', fontSize: 14 },
  notesCard:        { marginHorizontal: 12, marginBottom: 8, backgroundColor: '#fff', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#e5e7eb' },
  notesText:        { fontSize: 14, color: '#374151' },
  section:          { marginHorizontal: 12, marginBottom: 8, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: '#e5e7eb', overflow: 'hidden' },
  sectionTitle:     { fontSize: 13, fontWeight: '700', color: '#374151', padding: 14, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  ...
  owesBox:          { backgroundColor: '#fef2f2', borderRadius: 12, padding: 14, marginBottom: 4, borderWidth: 1, borderColor: '#fecaca' },
  owesName:         { fontSize: 15, fontWeight: '700', color: '#111827' },
  owesAmt:          { fontSize: 18, fontWeight: '800', color: '#dc2626', marginTop: 4 },
  previewRow:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 12, borderRadius: 10, marginTop: 8 },
