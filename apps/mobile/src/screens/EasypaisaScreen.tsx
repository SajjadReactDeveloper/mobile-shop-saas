...
const s = StyleSheet.create({
  ...
  historyBtn:      { flex: 1, backgroundColor: '#f0fdfa', borderRadius: 12, paddingVertical: 11, alignItems: 'center', borderWidth: 1, borderColor: '#ccfbf1' },
  historyBtnText:  { color: '#0d9488', fontWeight: '700', fontSize: 12 },
  historyPanel:    { paddingHorizontal: 14, paddingBottom: 10 },
  historyDivider:  { height: 1, backgroundColor: '#f0fdfa', marginBottom: 10 },
