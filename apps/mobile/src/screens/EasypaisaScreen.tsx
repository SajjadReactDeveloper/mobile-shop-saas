...
const s = StyleSheet.create({
  ...
  addBtn:          { backgroundColor: '#16a34a', paddingHorizontal: 14, paddingVertical: 7, borderRadius: 8 },
  addBtnText:      { color: '#fff', fontWeight: '700', fontSize: 13 },
  empty:           { textAlign: 'center', color: '#9ca3af', marginTop: 48, fontSize: 14, paddingHorizontal: 32, lineHeight: 22 },
  card:            { backgroundColor: '#fff', marginHorizontal: 12, marginTop: 10, borderRadius: 14, borderWidth: 1, borderColor: '#e5e7eb', overflow: 'hidden' },
  cardTop:         { flexDirection: 'row', alignItems: 'center', padding: 14 },
  walletIcon:      { width: 52, height: 52, borderRadius: 14, backgroundColor: '#dcfce7', justifyContent: 'center', alignItems: 'center' },
  walletEmoji:     { fontSize: 26 },
  accPhone:        { fontSize: 13, color: '#6b7280' },
  accBalance:      { fontSize: 22, fontWeight: '800', color: '#111827', marginTop: 2 },
  actionRow:       { flexDirection: 'row', gap: 10, paddingHorizontal: 14, paddingBottom: 14 },
  txnBtn:          { flex: 2, backgroundColor: '#16a34a', borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
  txnBtnText:      { color: '#fff', fontWeight: '700', fontSize: 13 },
  historyBtn:      { flex: 1, backgroundColor: '#f9fafb', borderRadius: 10, paddingVertical: 10, alignItems: 'center', borderWidth: 1, borderColor: '#e5e7eb' },
  historyBtnText:  { color: '#374151', fontWeight: '700', fontSize: 12 },
  historyPanel:    { paddingHorizontal: 14, paddingBottom: 10 },
  historyDivider:  { height: 1, backgroundColor: '#f3f4f6', marginBottom: 10 },
  historyEmpty:    { textAlign: 'center', color: '#9ca3af', fontSize: 13, paddingVertical: 12 },
  txnRow:          { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#f9fafb' },
  ...
  accInfoBox:      { backgroundColor: '#f0fdf4', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: '#bbf7d0', marginBottom: 4 },
  accInfoPhone:    { fontSize: 13, color: '#374151' },
  accInfoBalance:  { fontSize: 16, fontWeight: '700', color: '#111827', marginTop: 4 },
  typeGrid:        { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 4 },
  typeBtn:         { flexBasis: '30%', flexGrow: 1, alignItems: 'center', paddingVertical: 12, borderRadius: 10, backgroundColor: '#f9fafb', borderWidth: 1, borderColor: '#e5e7eb' },
  ...
  previewBox:      { borderRadius: 10, padding: 12, marginTop: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
