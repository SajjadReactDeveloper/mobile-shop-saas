...
const s = StyleSheet.create({
  ...
  loadBtn:        { flex: 1, backgroundColor: '#0d9488', borderRadius: 12, paddingVertical: 11, alignItems: 'center' },
  ...
  netOptionActive:{ borderColor: '#0d9488', backgroundColor: '#f0fdfa' },
  netOptionText:  { fontWeight: '700', fontSize: 13 },
  infoBox:        { backgroundColor: '#f0fdfa', borderRadius: 12, padding: 14, marginBottom: 4 },
  infoText:       { fontSize: 13, color: '#374151' },
  infoBal:        { fontSize: 16, fontWeight: '800', color: '#0d9488', marginTop: 4 },
