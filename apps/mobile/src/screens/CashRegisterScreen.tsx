...
const s = StyleSheet.create({
  ...
  openBtn:        { backgroundColor: '#0d9488', paddingHorizontal: 32, paddingVertical: 14, borderRadius: 16, shadowColor: '#0d9488', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
  ...
  cardTitle:      { fontSize: 12, fontWeight: '700', color: '#0d9488', marginBottom: 12, letterSpacing: 0.5, textTransform: 'uppercase' },
  ...
  totalVal:       { fontSize: 20, fontWeight: '800', color: '#0d9488' },
  // Quick sale row
  ...
  saleBtn:        { flex: 1, backgroundColor: '#0d9488', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  ...
  previewCard:    { flex: 1, backgroundColor: '#f0fdfa', borderRadius: 12, padding: 12, alignItems: 'center' },
