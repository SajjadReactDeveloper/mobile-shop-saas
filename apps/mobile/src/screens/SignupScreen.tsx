...
const s = StyleSheet.create({
  ...
  hero:         { backgroundColor: '#2563eb', paddingHorizontal: 24, paddingBottom: 28 },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '700', color: '#2563eb', letterSpacing: 1, marginTop: 20, marginBottom: 4 },
  ...
  btn:          { backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 28, shadowColor: '#2563eb', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
