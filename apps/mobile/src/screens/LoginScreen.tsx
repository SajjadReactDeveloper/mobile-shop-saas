      ...
      <View style={s.card}>
        <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            {(['email', 'phone'] as const).map(t => (
              ...
              >
                <Text style={[s.tabBtnText, tab === t && s.tabBtnTextActive]}>
                  {t === 'email' ? 'âœ‰ï¸  Email' : 'ðŸ“±  Phone OTP'}
                </Text>
              </TouchableOpacity>
            ))}
          </View>
            ...
            <>
              ...
              {otpSent && (
                <>
                  ...
                  <TextInput
                    ...
                    placeholder="â€¢ â€¢ â€¢ â€¢ â€¢ â€¢" placeholderTextColor="#9ca3af"
              ...
              >
                <Text style={s.btnText}>
                  {loading ? 'Please waitâ€¦' : otpSent ? 'Verify OTP' : 'Send OTP'}
                </Text>
              </TouchableOpacity>
              {otpSent && (
          ...
          <TouchableOpacity style={s.signupBtn} onPress={onSignup}>
            <Text style={s.signupText}>Create Free Account â†’</Text>
          </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  tabBtnActive:     { backgroundColor: '#0d9488', shadowColor: '#0d9488', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 3 },
  ...
  btn:              { backgroundColor: '#0d9488', borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 20, shadowColor: '#0d9488', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
  btnDisabled:      { opacity: 0.65 },
  btnText:          { color: '#fff', fontWeight: '700', fontSize: 16 },
  resendWrap:       { alignItems: 'center', marginTop: 12 },
  resendText:       { fontSize: 13, color: '#0d9488', fontWeight: '500' },
  ...
  signupBtn:        { borderWidth: 2, borderColor: '#0d9488', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  signupText:       { color: '#0d9488', fontWeight: '700', fontSize: 15 },
})
