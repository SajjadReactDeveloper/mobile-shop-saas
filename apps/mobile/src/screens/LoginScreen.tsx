...
const s = StyleSheet.create({
  ...
  tabBtnActive:     { backgroundColor: '#2563eb', shadowColor: '#2563eb', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 3 },
  ...
  btn:              { backgroundColor: '#2563eb', borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 20, shadowColor: '#2563eb', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
  ...
  signupBtn:        { borderWidth: 2, borderColor: '#2563eb', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  signupText:       { color: '#2563eb', fontWeight: '700', fontSize: 15 },
})
